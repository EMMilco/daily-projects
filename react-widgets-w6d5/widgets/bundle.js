...
var Root = function (_React$Component) {
  ...
  _createClass(Root, [{
    ...
    value: function render() {
      var articles = [{ title: "My Adventure in Alaska", content: "I was eaten yesterday by a bear." }, { title: "My Adventure in New York", content: "I was pooped on by a pidgeon." }];
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_clock2.default, null),
        _react2.default.createElement(_tabs2.default, { articles: articles })
      );
    }
  }]);
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function changeTab(idx) {
      ...
      return function () {
        _this2.setState({ selectedIndex: idx });
      };
    }
  }, {
    key: "setSelected",
    value: function setSelected(idx) {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.props.articles.map(function (article, idx) {
              return _react2.default.createElement(
                "li",
                { onClick: _this3.changeTab(idx), className: _this3.setSelected(idx), key: idx },
                article.title
              );
            })
          )
